 ...
 */
namespace SMTP2GOWPPlugin\Symfony\Component\Console;

use SMTP2GOWPPlugin\Symfony\Component\Console\Command\Command;
use SMTP2GOWPPlugin\Symfony\Component\Console\Command\HelpCommand;
use SMTP2GOWPPlugin\Symfony\Component\Console\Command\ListCommand;
use SMTP2GOWPPlugin\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
use SMTP2GOWPPlugin\Symfony\Component\Console\Event\ConsoleCommandEvent;
use SMTP2GOWPPlugin\Symfony\Component\Console\Event\ConsoleErrorEvent;
use SMTP2GOWPPlugin\Symfony\Component\Console\Event\ConsoleTerminateEvent;
use SMTP2GOWPPlugin\Symfony\Component\Console\Exception\CommandNotFoundException;
use SMTP2GOWPPlugin\Symfony\Component\Console\Exception\ExceptionInterface;
use SMTP2GOWPPlugin\Symfony\Component\Console\Exception\LogicException;
use SMTP2GOWPPlugin\Symfony\Component\Console\Exception\NamespaceNotFoundException;
use SMTP2GOWPPlugin\Symfony\Component\Console\Formatter\OutputFormatter;
use SMTP2GOWPPlugin\Symfony\Component\Console\Helper\DebugFormatterHelper;
use SMTP2GOWPPlugin\Symfony\Component\Console\Helper\FormatterHelper;
use SMTP2GOWPPlugin\Symfony\Component\Console\Helper\Helper;
use SMTP2GOWPPlugin\Symfony\Component\Console\Helper\HelperSet;
use SMTP2GOWPPlugin\Symfony\Component\Console\Helper\ProcessHelper;
use SMTP2GOWPPlugin\Symfony\Component\Console\Helper\QuestionHelper;
use SMTP2GOWPPlugin\Symfony\Component\Console\Input\ArgvInput;
use SMTP2GOWPPlugin\Symfony\Component\Console\Input\ArrayInput;
use SMTP2GOWPPlugin\Symfony\Component\Console\Input\InputArgument;
use SMTP2GOWPPlugin\Symfony\Component\Console\Input\InputAwareInterface;
use SMTP2GOWPPlugin\Symfony\Component\Console\Input\InputDefinition;
use SMTP2GOWPPlugin\Symfony\Component\Console\Input\InputInterface;
use SMTP2GOWPPlugin\Symfony\Component\Console\Input\InputOption;
use SMTP2GOWPPlugin\Symfony\Component\Console\Output\ConsoleOutput;
use SMTP2GOWPPlugin\Symfony\Component\Console\Output\ConsoleOutputInterface;
use SMTP2GOWPPlugin\Symfony\Component\Console\Output\OutputInterface;
use SMTP2GOWPPlugin\Symfony\Component\Console\Style\SymfonyStyle;
use SMTP2GOWPPlugin\Symfony\Component\Debug\ErrorHandler as LegacyErrorHandler;
use SMTP2GOWPPlugin\Symfony\Component\Debug\Exception\FatalThrowableError;
use SMTP2GOWPPlugin\Symfony\Component\ErrorHandler\ErrorHandler;
use SMTP2GOWPPlugin\Symfony\Component\EventDispatcher\EventDispatcherInterface;
use SMTP2GOWPPlugin\Symfony\Component\EventDispatcher\LegacyEventDispatcherProxy;
use SMTP2GOWPPlugin\Symfony\Contracts\Service\ResetInterface;
/**
...
class Application implements ResetInterface
{
    ...
    {
        return new InputDefinition([new InputArgument('command', InputArgument::REQUIRED, 'The command to execute'), new InputOption('--help', '-h', InputOption::VALUE_NONE, 'Display this help message'), new InputOption('--quiet', '-q', InputOption::VALUE_NONE, 'Do not output any message'), new InputOption('--verbose', '-v|vv|vvv', InputOption::VALUE_NONE, 'Increase the verbosity of messages: 1 for normal output, 2 for more verbose output and 3 for debug'), new InputOption('--version', '-V', InputOption::VALUE_NONE, 'Display this application version'), new InputOption('--ansi', '', InputOption::VALUE_NONE, 'Force ANSI output'), new InputOption('--no-ansi', '', InputOption::VALUE_NONE, 'Disable ANSI output'), new InputOption('--no-interaction', '-n', InputOption::VALUE_NONE, 'Do not ask any interactive question')]);
    }
    /**
