...
use SMTP2GOWPPlugin\PhpParser\Node\Scalar;
use SMTP2GOWPPlugin\PhpParser\Node\Stmt;
...
final class BuilderHelpers
{
    ...
    public static function normalizeIdentifier($name) : Identifier
    {
        ...
        throw new \LogicException('SMTP2GOWPPlugin\\Expected string or instance of Node\\Identifier');
    }
    /**
    ...
    public static function normalizeIdentifierOrExpr($name)
    {
        ...
        throw new \LogicException('SMTP2GOWPPlugin\\Expected string or instance of Node\\Identifier or Node\\Expr');
    }
    /**
    ...
    private static function normalizeNameCommon($name, bool $allowExpr)
    {
        ...
        if ($allowExpr) {
            ...
            throw new \LogicException('SMTP2GOWPPlugin\\Name must be a string or an instance of Node\\Name or Node\\Expr');
        }
        throw new \LogicException('SMTP2GOWPPlugin\\Name must be a string or an instance of Node\\Name');
    }
    /**
    ...
    public static function normalizeDocComment($docComment) : Comment\Doc
    {
        ...
        throw new \LogicException('SMTP2GOWPPlugin\\Doc comment must be a string or an instance of PhpParser\\Comment\\Doc');
    }
    /**
    ...
    public static function normalizeAttribute($attribute) : Node\AttributeGroup
    {
        ...
        if (!$attribute instanceof Node\Attribute) {
            throw new \LogicException('SMTP2GOWPPlugin\\Attribute must be an instance of PhpParser\\Node\\Attribute or PhpParser\\Node\\AttributeGroup');
        }
