 ...
 * @link https://secure.php.net/manual/en/class.zmq.php
 */
\class_alias('SMTP2GOWPPlugin\\ZMQ', 'ZMQ', \false);
/**
 * Class ZMQContext
 ...
 * @link https://secure.php.net/manual/en/class.zmqcontext.php
 */
\class_alias('SMTP2GOWPPlugin\\ZMQContext', 'ZMQContext', \false);
/**
 * Class ZMQSocket
 ...
 * @link https://secure.php.net/manual/en/class.zmqsocket.php
 */
\class_alias('SMTP2GOWPPlugin\\ZMQSocket', 'ZMQSocket', \false);
/**
 * Class ZMQPoll
 ...
 * @link https://secure.php.net/manual/en/class.zmqpoll.php
 */
\class_alias('SMTP2GOWPPlugin\\ZMQPoll', 'ZMQPoll', \false);
/**
 * Class ZMQDevice
 ...
 * @link https://secure.php.net/manual/en/class.zmqdevice.php
 */
\class_alias('SMTP2GOWPPlugin\\ZMQDevice', 'ZMQDevice', \false);
class ZMQException extends \Exception
{
}
\class_alias('SMTP2GOWPPlugin\\ZMQException', 'ZMQException', \false);
class ZMQContextException extends \ZMQException
{
}
\class_alias('SMTP2GOWPPlugin\\ZMQContextException', 'ZMQContextException', \false);
class ZMQSocketException extends \ZMQException
{
}
\class_alias('SMTP2GOWPPlugin\\ZMQSocketException', 'ZMQSocketException', \false);
class ZMQPollException extends \ZMQException
{
}
\class_alias('SMTP2GOWPPlugin\\ZMQPollException', 'ZMQPollException', \false);
class ZMQDeviceException extends \ZMQException
{
}
\class_alias('SMTP2GOWPPlugin\\ZMQDeviceException', 'ZMQDeviceException', \false);
