 ...
 */
namespace SMTP2GOWPPlugin\MongoDB;

namespace SMTP2GOWPPlugin\MongoDB\Driver;
...
final class Manager
{
     ...
     */
    public final function executeBulkWrite($namespace, BulkWrite $bulk, $options = [])
    {
    }
    /**
     ...
     * @since 1.4.0 added $options argument
     */
    public final function executeQuery($namespace, Query $query, $options = [])
    {
    }
    /**
...
final class Server
{
     ...
     * @since 1.0.0
     */
    public final function executeBulkWrite($namespace, BulkWrite $zwrite, $options = [])
    {
    }
    /**
     ...
     * @since 1.0.0
     */
    public final function executeCommand($db, Command $command, ReadPreference $readPreference = null)
    {
    }
    /**
     ...
     * @since 1.4.0
     */
    public final function executeReadCommand($db, Command $command, array $option = [])
    {
    }
    /**
     ...
     * @since 1.4.0
     */
    public final function executeReadWriteCommand($db, Command $command, array $option = [])
    {
    }
    /**
     ...
     * @since 1.4.0
     */
    public final function executeWriteCommand($db, Command $command, array $option = [])
    {
    }
    /**
     ...
     * @return Cursor
     */
    public final function executeQuery($namespace, Query $query, $option = [])
    {
    }
    /**
...
namespace SMTP2GOWPPlugin\MongoDB\Driver\Exception;
 ...
 */
namespace SMTP2GOWPPlugin\MongoDB\Driver\Monitoring;
 ...
 */
namespace SMTP2GOWPPlugin\MongoDB\BSON;
