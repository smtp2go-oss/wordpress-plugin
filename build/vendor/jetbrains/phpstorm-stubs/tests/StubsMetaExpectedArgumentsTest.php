...
use SMTP2GOWPPlugin\StubTests\Parsers\ExpectedFunctionArgumentsInfo;
use SMTP2GOWPPlugin\StubTests\Parsers\MetaExpectedArgumentsCollector;
...
class StubsMetaExpectedArgumentsTest extends TestCase
{
    ...
    {
        return self::flatten(\array_map(function (Model\PHPClass $class) {
        ...
        foreach (self::$expectedArguments as $argument) {
            ...
            foreach ($expectedArguments as $constantReference) {
                if ($constantReference instanceof ClassConstFetch) {
                    ...
                    if ($constantReference instanceof ConstFetch) {
