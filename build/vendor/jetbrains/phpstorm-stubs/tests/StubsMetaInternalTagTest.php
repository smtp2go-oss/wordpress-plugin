...
use SMTP2GOWPPlugin\StubTests\Parsers\Visitors\MetaOverrideFunctionsParser;
use SMTP2GOWPPlugin\StubTests\TestData\Providers\PhpStormStubsSingleton;
use SMTP2GOWPPlugin\StubTests\TestData\Providers\ReflectionStubsSingleton;
...
class StubsMetaInternalTagTest extends TestCase
{
    ...
    {
        self::assertContains($elementName, self::$overridenFunctionsInMeta, "{$elementName} contains @meta in phpdoc but isn't added to 'override()' functions in meta file");
    }
}
