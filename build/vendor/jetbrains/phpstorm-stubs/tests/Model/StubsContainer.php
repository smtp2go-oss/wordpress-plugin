...
class StubsContainer
{
    ...
    {
        return \array_filter($this->classes, fn($class): bool => $class->stubBelongsToCore === \true);
    }
    /**
    ...
    {
        return \array_filter($this->interfaces, fn($interface): bool => $interface->stubBelongsToCore === \true);
    }
    /**
