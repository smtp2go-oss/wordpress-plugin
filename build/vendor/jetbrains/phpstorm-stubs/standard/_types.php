 ...
 * @link https://wiki.php.net/rfc/generators
 */
\class_alias('SMTP2GOWPPlugin\\Generator', 'Generator', \false);
class ClosedGeneratorException extends \Exception
{
}
\class_alias('SMTP2GOWPPlugin\\ClosedGeneratorException', 'ClosedGeneratorException', \false);
namespace SMTP2GOWPPlugin\___PHPSTORM_HELPERS;
