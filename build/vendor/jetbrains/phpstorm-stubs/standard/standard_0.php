...
\class_alias('SMTP2GOWPPlugin\\__PHP_Incomplete_Class', '__PHP_Incomplete_Class', \false);
...
\class_alias('SMTP2GOWPPlugin\\php_user_filter', 'php_user_filter', \false);
/**
 ...
 * Instances of Directory are created by calling the dir() function, not by the new operator.
 */
\class_alias('SMTP2GOWPPlugin\\Directory', 'Directory', \false);
/**
 ...
 */
#[Pure]
function htmlentities(string $string, int $flags, ?string $encoding, bool $double_encode = \true) : string
{
}
/**
