...
// Start of Zend Extensions
\class_alias('SMTP2GOWPPlugin\\ZendAPI_Queue', 'ZendAPI_Queue', \false);
/**
 ...
 * For simplicity, a job can be added directly to a queue and without creating an instant of a Queue object
 */
\class_alias('SMTP2GOWPPlugin\\ZendAPI_Job', 'ZendAPI_Job', \false);
/**
...
\class_alias('SMTP2GOWPPlugin\\java', 'java', \false);
class JavaException
{
    /**
...
\class_alias('SMTP2GOWPPlugin\\JavaException', 'JavaException', \false);
