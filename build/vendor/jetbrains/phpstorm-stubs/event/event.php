...
// The Event class
use SMTP2GOWPPlugin\JetBrains\PhpStorm\Immutable;
 ...
 * @see https://php.net/manual/en/class.event.php
 */
\class_alias('SMTP2GOWPPlugin\\Event', 'Event', \false);
//  The EventBase class
/**
 * EventBase.
 ...
 * @see https://php.net/manual/en/class.eventbase.php
 */
\class_alias('SMTP2GOWPPlugin\\EventBase', 'EventBase', \false);
 ...
 * @see https://php.net/manual/en/class.eventbuffer.php
 */
\class_alias('SMTP2GOWPPlugin\\EventBuffer', 'EventBuffer', \false);
 ...
 * @see https://php.net/manual/en/class.eventbufferevent.php
 */
\class_alias('SMTP2GOWPPlugin\\EventBufferEvent', 'EventBufferEvent', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventconfig.php
 */
\class_alias('SMTP2GOWPPlugin\\EventConfig', 'EventConfig', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventdnsbase.php
 */
\class_alias('SMTP2GOWPPlugin\\EventDnsBase', 'EventDnsBase', \false);
// The EventHttp class
/**
 * EventHttp.
 ...
 * @see https://secure.php.net/manual/en/class.eventhttp.php
 */
\class_alias('SMTP2GOWPPlugin\\EventHttp', 'EventHttp', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventhttpconnection.php
 */
\class_alias('SMTP2GOWPPlugin\\EventHttpConnection', 'EventHttpConnection', \false);
...
// The EventHttpRequest class
\class_alias('SMTP2GOWPPlugin\\EventHttpRequest', 'EventHttpRequest', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventlistener.php
 */
\class_alias('SMTP2GOWPPlugin\\EventListener', 'EventListener', \false);
 ...
 * @see https://secure.php.net/manual/en/class.eventsslcontext.php
 */
\class_alias('SMTP2GOWPPlugin\\EventSslContext', 'EventSslContext', \false);
// The EventUtil class
/**
 * EventUtil.
 ...
 * @see https://secure.php.net/manual/en/class.eventutil.php
 */
\class_alias('SMTP2GOWPPlugin\\EventUtil', 'EventUtil', \false);
