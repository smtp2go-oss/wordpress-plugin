...
// Start of ming v.
\class_alias('SMTP2GOWPPlugin\\SWFShape', 'SWFShape', \false);
class SWFFill
{
    public function __construct()
    {
...
\class_alias('SMTP2GOWPPlugin\\SWFFill', 'SWFFill', \false);
class SWFGradient
{
    public function __construct()
    {
...
\class_alias('SMTP2GOWPPlugin\\SWFGradient', 'SWFGradient', \false);
class SWFBitmap
{
    public function __construct()
    {
...
\class_alias('SMTP2GOWPPlugin\\SWFBitmap', 'SWFBitmap', \false);
class SWFText
{
    public function __construct()
    {
...
\class_alias('SMTP2GOWPPlugin\\SWFText', 'SWFText', \false);
class SWFTextField
{
    public function __construct()
    {
...
\class_alias('SMTP2GOWPPlugin\\SWFTextField', 'SWFTextField', \false);
class SWFFont
{
    public function __construct()
    {
...
\class_alias('SMTP2GOWPPlugin\\SWFFont', 'SWFFont', \false);
...
\class_alias('SMTP2GOWPPlugin\\SWFDisplayItem', 'SWFDisplayItem', \false);
class SWFMovie
{
    public function __construct()
    {
...
\class_alias('SMTP2GOWPPlugin\\SWFMovie', 'SWFMovie', \false);
class SWFButton
{
    public function __construct()
    {
...
\class_alias('SMTP2GOWPPlugin\\SWFButton', 'SWFButton', \false);
class SWFAction
{
    public function __construct()
    {
...
\class_alias('SMTP2GOWPPlugin\\SWFAction', 'SWFAction', \false);
class SWFMorph
{
    public function __construct()
    {
...
\class_alias('SMTP2GOWPPlugin\\SWFMorph', 'SWFMorph', \false);
class SWFSprite
{
    public function __construct()
    {
...
\class_alias('SMTP2GOWPPlugin\\SWFSprite', 'SWFSprite', \false);
class SWFSound
{
    public function __construct()
    {
...
\class_alias('SMTP2GOWPPlugin\\SWFSound', 'SWFSound', \false);
class SWFFontChar
{
    public function addChars()
    {
...
\class_alias('SMTP2GOWPPlugin\\SWFFontChar', 'SWFFontChar', \false);
...
\class_alias('SMTP2GOWPPlugin\\SWFSoundInstance', 'SWFSoundInstance', \false);
...
\class_alias('SMTP2GOWPPlugin\\SWFVideoStream', 'SWFVideoStream', \false);
/**
 * Set cubic threshold
