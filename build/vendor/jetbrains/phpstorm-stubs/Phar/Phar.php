 ...
 * @link https://php.net/manual/en/class.pharexception.php
 */
\class_alias('SMTP2GOWPPlugin\\PharException', 'PharException', \false);
/**
...
class Phar extends \RecursiveDirectoryIterator implements \RecursiveIterator, \SeekableIterator, \Countable, \ArrayAccess
{
     ...
     */
    public static final function canCompress($compression = 0)
    {
    }
    /**
     * (PHP &gt;= 5.3.0, PECL phar &gt;= 1.0.0)<br/>
     ...
     */
    public static final function canWrite()
    {
    }
    /**
     * (Unknown)<br/>
     ...
     * enabled.
     */
    public static final function createDefaultStub($index = null, $webIndex = null)
    {
    }
    /**
     * (PHP &gt;= 5.3.0, PECL phar &gt;= 1.2.0)<br/>
     ...
     * bz2 extension.
     */
    public static final function getSupportedCompression()
    {
    }
    /**
     * (PHP &gt;= 5.3.0, PECL phar &gt;= 1.1.0)<br/>
     ...
     * SHA-256, SHA-512, or OpenSSL.
     */
    public static final function getSupportedSignatures()
    {
    }
    /**
     * (PHP &gt;= 5.3.0, PECL phar &gt;= 2.0.0)<br/>
     ...
     * @return void
     */
    public static final function interceptFileFuncs()
    {
    }
    /**
     * (PHP &gt;= 5.3.0, PECL phar &gt;= 1.2.0)<br/>
     ...
     */
    public static final function isValidPharFilename($filename, $executable = \true)
    {
    }
    /**
     * (PHP &gt;= 5.3.0, PECL phar &gt;= 1.0.0)<br/>
     ...
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     */
    public static final function loadPhar($filename, $alias = null)
    {
    }
    /**
     * (PHP &gt;= 5.3.0, PECL phar &gt;= 1.0.0)<br/>
     ...
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     */
    public static final function mapPhar($alias = null, $offset = 0)
    {
    }
    /**
     * (PHP &gt;= 5.3.0, PECL phar &gt;= 2.0.0)<br/>
     ...
     */
    public static final function running($returnPhar = \true)
    {
    }
    /**
     * (PHP &gt;= 5.3.0, PECL phar &gt;= 2.0.0)<br/>
     ...
     */
    public static final function mount($pharPath, $externalPath)
    {
    }
    /**
     * (Unknown)<br/>
     ...
     */
    public static final function mungServer(array $variables)
    {
    }
    /**
     * (PHP &gt;= 5.3.0, PECL phar &gt;= 2.0.0)<br/>
     ...
     * @return bool <b>TRUE</b> on success or <b>FALSE</b> on failure.
     */
    public static final function unlinkArchive($filename)
    {
    }
    /**
     * (PHP &gt;= 5.3.0, PECL phar &gt;= 2.0.0)<br/>
     ...
     * @return void No value is returned.
     */
    public static final function webPhar($alias = null, $index = "index.php", $fileNotFoundScript = null, array $mimeTypes = null, callable $rewrite = null)
    {
    }
    /**
 ...
 * @link https://php.net/manual/en/class.phar.php
 */
\class_alias('SMTP2GOWPPlugin\\Phar', 'Phar', \false);
/**
 ...
 * @link https://php.net/manual/en/class.phardata.php
 */
\class_alias('SMTP2GOWPPlugin\\PharData', 'PharData', \false);
/**
 ...
 * @link https://php.net/manual/en/class.pharfileinfo.php
 */
\class_alias('SMTP2GOWPPlugin\\PharFileInfo', 'PharFileInfo', \false);
// End of Phar v.2.0.1
