 ...
 * @link https://secure.php.net/manual/en/class.yar-server.php
 */
\class_alias('SMTP2GOWPPlugin\\Yar_Server', 'Yar_Server', \false);
class Yar_Client
{
    protected $_protocol;
    protected $_uri;
...
\class_alias('SMTP2GOWPPlugin\\Yar_Client', 'Yar_Client', \false);
...
\class_alias('SMTP2GOWPPlugin\\Yar_Concurrent_Client', 'Yar_Concurrent_Client', \false);
/**
 ...
 * @link https://secure.php.net/manual/en/class.yar-server-exception.php
 */
\class_alias('SMTP2GOWPPlugin\\Yar_Server_Exception', 'Yar_Server_Exception', \false);
/**
 ...
 * @link https://secure.php.net/manual/en/class.yar-client-exception.php
 */
\class_alias('SMTP2GOWPPlugin\\Yar_Client_Exception', 'Yar_Client_Exception', \false);
