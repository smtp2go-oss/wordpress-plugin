...
// Start of svn v.1.0.1
\class_alias('SMTP2GOWPPlugin\\Svn', 'Svn', \false);
class SvnWc
{
    const NONE = 1;
    const UNVERSIONED = 2;
...
\class_alias('SMTP2GOWPPlugin\\SvnWc', 'SvnWc', \false);
class SvnWcSchedule
{
    const NORMAL = 0;
    const ADD = 1;
...
\class_alias('SMTP2GOWPPlugin\\SvnWcSchedule', 'SvnWcSchedule', \false);
class SvnNode
{
    const NONE = 0;
    const FILE = 1;
...
\class_alias('SMTP2GOWPPlugin\\SvnNode', 'SvnNode', \false);
/**
 * (PECL svn &gt;= 0.1.0)<br/>
