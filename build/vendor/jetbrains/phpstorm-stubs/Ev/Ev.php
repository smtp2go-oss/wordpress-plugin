 ...
 * Ev is a singleton providing access to the default loop and to some common operations.
 */
\class_alias('SMTP2GOWPPlugin\\Ev', 'Ev', \false);
/**
 * Class EvWatcher
 */
 ...
 * Class EvWatcher
 */
\class_alias('SMTP2GOWPPlugin\\EvWatcher', 'EvWatcher', \false);
/**
 * Class EvCheck
 *
 ...
 * before other EvCheck watchers did their job.
 */
\class_alias('SMTP2GOWPPlugin\\EvCheck', 'EvCheck', \false);
/**
 * Class EvChild
 *
 ...
 * It is allowed to register EvChild watchers in the default loop only.
 */
\class_alias('SMTP2GOWPPlugin\\EvChild', 'EvChild', \false);
/**
 * Class EvEmbed
 *
 ...
 * Used to embed one event loop into another.
 */
\class_alias('SMTP2GOWPPlugin\\EvEmbed', 'EvEmbed', \false);
/**
 * Class EvIo
 *
 ...
 * Always consider using non-blocking mode.
 */
\class_alias('SMTP2GOWPPlugin\\EvIo', 'EvIo', \false);
/**
 * Class EvPeriodic
 *
 ...
 * recursively).
 */
\class_alias('SMTP2GOWPPlugin\\EvPeriodic', 'EvPeriodic', \false);
/**
 * Class EvPrepare
 *
 * EvPrepare and EvCheck watchers are usually used in pairs. EvPrepare watchers get invoked before the process blocks,
 ...
 * before other EvCheck watchers did their job.
 */
\class_alias('SMTP2GOWPPlugin\\EvPrepare', 'EvPrepare', \false);
/**
 * Class EvSignal
 *
 ...
 * all the signals can be blocked in an EvCheck watcher and unblocked in a EvPrepare watcher.
 */
\class_alias('SMTP2GOWPPlugin\\EvSignal', 'EvSignal', \false);
/**
 * Class EvStat
 *
 ...
 * notifications, this can be resource-intensive.
 */
\class_alias('SMTP2GOWPPlugin\\EvStat', 'EvStat', \false);
/**
 * Class EvTimer
 *
 ...
 * iteration.
 */
\class_alias('SMTP2GOWPPlugin\\EvTimer', 'EvTimer', \false);
/**
 * Class EvIdle
 *
 ...
 * for new events.
 */
\class_alias('SMTP2GOWPPlugin\\EvIdle', 'EvIdle', \false);
/**
 * Class EvFork
 *
 ...
 *
 */
\class_alias('SMTP2GOWPPlugin\\EvFork', 'EvFork', \false);
/**
 * Class EvLoop
 *
 ...
 * EvLoop::defaultLoop() method.
 */
\class_alias('SMTP2GOWPPlugin\\EvLoop', 'EvLoop', \false);
