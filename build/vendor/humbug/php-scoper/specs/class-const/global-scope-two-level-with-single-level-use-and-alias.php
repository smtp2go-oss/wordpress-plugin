...
PHP
], 'FQ Constant call on a whitelisted namespaced class partially imported with an aliased use statement' => ['whitelist' => ['SMTP2GOWPPlugin\\Foo\\Bar'], 'registered-classes' => [['SMTP2GOWPPlugin\\Foo\\Bar', 'SMTP2GOWPPlugin\\Humbug\\Foo\\Bar']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'FQ constant call on a whitelisted namespaced class imported with an aliased use statement' => ['whitelist' => ['SMTP2GOWPPlugin\\Foo\\Bar'], 'payload' => <<<'PHP'
<?php
