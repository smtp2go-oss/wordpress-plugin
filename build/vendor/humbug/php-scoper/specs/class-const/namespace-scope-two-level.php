...
PHP
], 'Constant call on a whitelisted namespaced class' => ['whitelist' => ['SMTP2GOWPPlugin\\X\\PHPUnit\\Command'], 'registered-classes' => [['SMTP2GOWPPlugin\\X\\PHPUnit\\Command', 'SMTP2GOWPPlugin\\Humbug\\X\\PHPUnit\\Command']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'FQ constant call on a whitelisted namespaced class' => ['whitelist' => ['SMTP2GOWPPlugin\\PHPUnit\\Command'], 'registered-classes' => [['SMTP2GOWPPlugin\\PHPUnit\\Command', 'SMTP2GOWPPlugin\\Humbug\\PHPUnit\\Command']], 'payload' => <<<'PHP'
<?php
