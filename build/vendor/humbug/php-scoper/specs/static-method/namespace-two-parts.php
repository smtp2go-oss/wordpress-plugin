...
PHP
, 'Static method call statement of a whitelisted class' => ['whitelist' => ['SMTP2GOWPPlugin\\X\\Foo\\Bar'], 'registered-classes' => [['SMTP2GOWPPlugin\\X\\Foo\\Bar', 'SMTP2GOWPPlugin\\Humbug\\X\\Foo\\Bar']], 'payload' => <<<'PHP'
<?php
...
PHP
], 'FQ static method call statement of a non-whitelisted class' => ['whitelist' => ['SMTP2GOWPPlugin\\X\\Foo\\Bar'], 'payload' => <<<'PHP'
<?php
