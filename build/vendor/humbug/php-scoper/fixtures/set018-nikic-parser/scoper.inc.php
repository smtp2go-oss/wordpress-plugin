...
return ['patchers' => [static function (string $filePath, string $prefix, string $contents) : string {
    ...
    $finderClass = \sprintf('\\%s\\%s', $prefix, \SMTP2GOWPPlugin\Isolated\Symfony\Component\Finder\Finder::class);
    return \str_replace($finderClass, '\\' . \SMTP2GOWPPlugin\Isolated\Symfony\Component\Finder\Finder::class, $contents);
}]];
