...
use SMTP2GOWPPlugin\Humbug\PhpScoper\Console\Application;
use SMTP2GOWPPlugin\Humbug\PhpScoper\Console\ApplicationFactory;
use Iterator;
use SMTP2GOWPPlugin\PackageVersions\Versions;
