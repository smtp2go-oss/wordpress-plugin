...
use SMTP2GOWPPlugin\Humbug\PhpScoper\Patcher\SymfonyPatcher;
...
final class Configuration
{
     ...
     */
    private function __construct(?string $path, ?string $prefix, array $filesWithContents, array $patchers, Whitelist $whitelist, array $whitelistedFiles)
    {
        $this->path = $path;
        $this->prefix = $prefix;
