...
use SMTP2GOWPPlugin\Humbug\PhpScoper\PhpParser\Node\NameFactory;
use SMTP2GOWPPlugin\PhpParser\Node;
use SMTP2GOWPPlugin\PhpParser\Node\Stmt;
use SMTP2GOWPPlugin\PhpParser\Node\Stmt\Declare_;
use SMTP2GOWPPlugin\PhpParser\Node\Stmt\GroupUse;
use SMTP2GOWPPlugin\PhpParser\Node\Stmt\InlineHTML;
...
use SMTP2GOWPPlugin\PhpParser\NodeTraverser as PhpParserNodeTraverser;
