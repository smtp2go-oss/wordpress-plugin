...
final class InitCommand extends BaseCommand
{
    ...
    {
        parent::configure();
        $this->setName('init')->setDescription('Generates a configuration file.')->addOption(self::CONFIG_FILE_OPT, 'c', InputOption::VALUE_REQUIRED, sprintf('Configuration file. Will use "%s" if found by default.', self::CONFIG_FILE_DEFAULT), null);
    }
    /**
     * @inheritdoc
     */
