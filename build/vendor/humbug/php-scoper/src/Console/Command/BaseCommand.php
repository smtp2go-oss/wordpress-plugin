...
abstract class BaseCommand extends Command
{
    ...
    {
        $this->addOption(self::WORKING_DIR_OPT, 'd', InputOption::VALUE_REQUIRED, 'If specified, use the given directory as working directory.', null);
    }
    public final function changeWorkingDirectory(InputInterface $input) : void
    {
