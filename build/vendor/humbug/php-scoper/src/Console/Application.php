...
use function SMTP2GOWPPlugin\Humbug\PhpScoper\get_php_scoper_version;
...
ASCII;
     ...
     * {@inheritdoc}
     */
    public function __construct(Container $container, string $name = 'Box', ?string $version = null, string $releaseDate = '@release-date@')
    {
